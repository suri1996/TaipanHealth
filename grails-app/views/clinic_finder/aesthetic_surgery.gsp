  ...
  <body>
		<div class = "container content">
			...
			<div class = "container" id = "nav_item">
				...
				<div class="col-md-3 col-sm-3">
					<g:link controller = "clinic_finder"   action = "oncology" class ="btn"  params = "${[ lang : session.'org.springframework.web.servlet.i18n.SessionLocaleResolver.LOCALE']}">
						<g:message code = "my.localized.oncology"/>
					</g:link>
				</div>
				<div class="col-md-3 col-sm-3">
					<g:link controller = "clinic_finder"  action = "aesthetic_surgery" class="btn btn-success" params = "${[ lang : session.'org.springframework.web.servlet.i18n.SessionLocaleResolver.LOCALE']}">
