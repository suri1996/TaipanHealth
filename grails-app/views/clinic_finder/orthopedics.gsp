  ...
  <body>
		<div class = "container content">
			...
			<div class = "container" id = "nav_item">
				<div class="col-md-3 col-sm-3">
					<g:link controller = "clinic_finder"  action = "orthopedics" class = "btn btn-success"  params = "${[ lang : session.'org.springframework.web.servlet.i18n.SessionLocaleResolver.LOCALE']}">
