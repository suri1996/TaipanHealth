...
<body>
  ...
  <asset:stylesheet src="stepbar.css"/>
  <!-- Animate.css -->
    ...
    <nav class="navbar navbar-default" role="navigation">
      <div class="container-fluid">
        ...
        <ul class = "lang">
          ...
          <li><a id = "en" href = "/en/${params.controller}/${params.action}">EN</a></li> |
          <li><a id = "zt" href = "/zt/${params.controller}/${params.action}">繁</a></li> |
          <li><a id = "zs" href = "/zs/${params.controller}/${params.action}">简</a></li>
        </ul>
        <div id="fh5co-navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><g:link controller = "scan" action="bone" params = "${[ lang : session.'org.springframework.web.servlet.i18n.SessionLocaleResolver.LOCALE']}"><span style="color:#004080;"><g:message code="my.localized.scan" /><span class="border"></span></span></g:link></li>
            ...
            <li><g:link controller = "storage" params = "${[ lang : session.'org.springframework.web.servlet.i18n.SessionLocaleResolver.LOCALE']}"><span style="color:#004080;"><g:message code="my.localized.storage" /><span class="border"></span></span></g:link></li>
            ...
            <li class="dropdown" id = "lang_nav">
              ...
              <ul class = "dropdown-menu">
                <a id = "en_mobile" href = "/en/${params.controller}/${params.action}"><li><span>EN<span class="border"></span></span></li></a>
                <a id = "zt_mobile" href = "/zt/${params.controller}/${params.action}"><li><span>繁<span class="border"></span></span></li><a>
                <a id = "zs_mobile" href = "/zs/${params.controller}/${params.action}"><li><span>简<span class="border"></span></span></li></a>
