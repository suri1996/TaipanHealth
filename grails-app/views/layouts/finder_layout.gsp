...
<head>
    ...
    <title><g:message code="my.localized.footera" /> | <g:message code="my.localized.finder" /></title>
...
<body>
  ...
  <header id="fh5co-header" role="banner">
    ...
    <!--        <li><a href="#"><span style="color:#004080;"><g:message code="my.localized.finder" /><span class="border"></span></span></a></li> !-->
